...
type UsernameState = 'idle' | 'checking' | 'ok' | 'notfound' | 'offline' | 'invalid' | 'error';
...
export default function ChessComUsername({ navigation }: Props) {
  ...
  const getErrorMessage = (): string => {
    switch (state) {
      ...
      case 'offline':
        return 'You\'re offline. Try again when connected, or skip for now.';
      case 'error':
      ...
      >
        <View style={styles.content}>
          ...
          <View style={styles.skipContainer}>
            ...
            <TouchableOpacity
              style={styles.pgnLink}
              onPress={() => {
                // Placeholder for PGN import functionality
                Alert.alert('Coming Soon', 'PGN import will be available in a future update.');
              }}
              accessibilityRole="button"
              accessibilityLabel="Import PGN instead"
            >
              <Text style={styles.pgnLinkText}>Or paste a PGN instead</Text>
            </TouchableOpacity>
          </View>
        </View>
      </KeyboardAvoidingView>
