...
const cards: Card[] = [
  {
    title: 'Training that targets your weaknesses',
    body: 'We analyze your games and focus on recurring motifs like forks, pins, and back-rank mates.',
  },
  {
    title: 'Short, focused sessions',
    body: 'Do a "Daily 10" with concise explanations—ideas, not just moves.',
  },
  {
    title: 'Adapts as you improve',
    body: 'More reps for weak themes; harder puzzles for mastered ones.',
  },
];
